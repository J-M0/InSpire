...
export default class ImportantNotices extends React.Component {
  ...
  refresh() {
    ...
    //console.log(this.state.academicInstitution);
  }
      ...
      return (
				<div className="panel panel-default" id="todo">
					...
					<div className="panel-body">
						...
						<a href="#Tax" data-toggle="modal" data-target="#taxreturnModal">Tax Return</a><br />
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <div className="panel panel-default" id="todo-list-items">
                      ...
                      <p style={{marginLeft:'20px'}}>You may be eligible for financial aid. To be considered, complete the 2016-2017 FAFSA online at fafsa.gov. Depending upon your individual situation, deadlines and rules vary. Information regarding eligibility, applying and deadlines is available at www.umass.edu/umfa/. Please note, some state tuition credit programs require you to complete the FAFSA. Also, you must complete the FAFSA to apply for the Federal Direct PLUS loan.</p>
                      <br />
                ...
                <div id="taxreturnModal" className="modal fade" role="dialog">
                  <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                      <div className="modal-header">
                        <button type="button" className="close" data-dismiss="modal">&times;</button>
                        <h4 className="modal-title" style={{color:'#354066'}}>Tax Return</h4>
                      </div>
                      <div className="modal-body">
                        <div className="panel panel-default" id="todo-list-items">
