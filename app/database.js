...
var initialData = {
    ...
    "courses": {
        "12345678": {
            ...
            "enrolled": [],
            "instructor": "12345678",
            "final": [new Date(2017, 0, 22),new Date(0,0,0,8,0), new Date(0,0,0,10,0), "School of Management rm 136"],
            "category": "art",
        ...
        "92819522": {
            ...
            "enrolled": [],
            "instructor": "83719683",
            "final": [new Date(2017, 1, 22),new Date(0,0,0,8,30),new Date(0,0,0,10,30), "School of Management rm 136"],
            "category": "literature",
        ...
        "19103958": {
            ...
            "enrolled": [],
            "instructor": "83719683",
            "final": [new Date(2017, 2, 22),new Date(0,0,0,11,15),new Date(0,0,0,13,15), "Thompson Hall room 105"],
            "category": "cs",
        ...
        "18271821": {
            ...
            "enrolled": [],
            "instructor": "12345678",
            "final": [new Date(2017, 3, 22),new Date(0,0,0,14,30), new Date(0,0,0,16,30), "Thompson Hall room 106"],
            "category": "history",
        ...
        "85938173": {
            ...
            "enrolled": [],
            "instructor": "23810589",
            "final": [new Date(2017, 4, 22),new Date(0,0,0,15,0), new Date(0,0,0,17,0), "Lederle Grad Res Ctr rm A301"],
            "category": "music",
        ...
        "09876543": {
            ...
            "enrolled": [],
            "instructor": "23810589",
            "final": [new Date(2017, 5, 22),new Date(0,0,0,17,30),new Date(0,0,0,19,30),"Hasbrouck Lab Add room 126"],
            "category": "gym",
        ...
        "08874563": {
          ...
          "enrolled": [],
          "instructor": "23810589",
          "final": [new Date(2017, 5, 22),new Date(0,0,0,11,15), new Date(0,0,0,13,15),"Computer Science Bldg rm 141"],
          "category": "gym",
          "start" : new Date(0,0,0,11,15),
          "end" : new Date(0,0,0,12,5),
